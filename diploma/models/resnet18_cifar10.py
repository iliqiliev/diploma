...
from ..datasets import CIFAR10_CLASSES, CIFAR10_NORMALIZATION, get_cifar10_loaders
...
class Cifar10(BaseModel):
    ...
    def get(
        ...
        """
        Return the ResNet18 CNN (Convolutional Neural Network)
        model for CIFAR10 classification.
